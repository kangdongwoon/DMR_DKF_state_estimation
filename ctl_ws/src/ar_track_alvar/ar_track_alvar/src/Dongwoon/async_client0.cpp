...
int main(int argc, char* argv[])
{
    ...
    ros::Subscriber sub = nh.subscribe("/tb3_2/odom", 1, tb0_trans);
    ros::Publisher pub = nh.advertise<geometry_msgs::Twist>("/tb0/cmd_vel",10);
